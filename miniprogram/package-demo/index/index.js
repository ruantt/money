...
Page({
  ...
  onClickPowerInfo(e) {
    ...
    if (selectedItem.link) {
      ...
      wx.navigateTo({
          url: `/package-demo/example/index?envId=${this.data.selectedEnv?.envId}&type=${selectedItem.type}`,
      });
  ...
  jumpPage(e) {
    ...
    if (type) {
      wx.navigateTo({
        url: `/package-demo/example/index?envId=${this.data.selectedEnv?.envId}&type=${type}`,
      });
    } else {
      wx.navigateTo({
